...
public class TextSingleUserByHour extends Configured implements Tool {
	...
	public static class MyMapper extends Mapper<LongWritable, Text, Text, Text>{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
			...
			context.write(new Text(buffer.append(userId).append(mapSecp).append(startTime).toString()), new Text(buffer
						.append(corpId)
						.append(mapSecp)
						.append(userId)
						.append(mapSecp)
	...
	public static class MyReducer extends Reducer<Text, Text, Text, Text>{
		...
		public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException{
			...
			String[] orgKey = key.toString().split(mapSecp);
			buffer.setLength(0);
			if(0 != connected){
				context.write(new Text(orgKey[0]), new Text(buffer
							.append(orgKey[1])
	...
	public int run(String[] args) throws Exception{
		...
		job.setJarByClass(TextSingleUserByHour.class);
	...
	public static void main(String[] args) throws Exception{
		int res = ToolRunner.run(new Configuration(), new TextSingleUserByHour(), args);
		System.exit(res);
	}
}
